-- =============================================================================
-- DFC Postos · regime de caixa · ANO 2025 (carga histórica)
--
-- Cópia da SQL DFC.sql (Automate) com as datas trocadas pra 2025-01-01..2026-01-01.
-- Roda na "Consulta SQL" do Adaptive → exporta como DFC_Postos_2025.xls
-- (precisa conter "DFC" no nome pra o ETL achar). Salva em /Automate/.
-- ETL: etl_dfc_postos_sql.py "/mnt/controller/03 - POSTOS/Automate/DFC_Postos_2025.xls"
-- =============================================================================
...
WHERE tf.pagar_receber = 1
  AND tf.data_liquidacao >= DATE '2025-01-01' AND tf.data_liquidacao < DATE '2026-01-01'
...
WHERE mf.denominacao_tipo_movto_financ ILIKE '%Dep_sito%'
  ...
  AND mf.data_movimento >= DATE '2025-01-01' AND mf.data_movimento < DATE '2026-01-01'
